...
case class DeductionsAuditDetail(userType: String,
...
object DeductionsAuditDetail {

  implicit val writes: OWrites[DeductionsAuditDetail] = (
  ...
  )(unlift(DeductionsAuditDetail.unapply))

  def apply(userDetails: UserDetails,
            params: Map[String, String],
            requestBody: Option[JsValue],
            `X-CorrelationId`: String,
            auditResponse: AuditResponse): DeductionsAuditDetail = {
